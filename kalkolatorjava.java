 ...
 * @author LENOVO
 */
public class kalkolatorjava extends javax.swing.JFrame {

    /**
     * Creates new form kalkol
     */
    double num, ans;
    int kalkulator;

    public kalkolatorjava() {
        initComponents();
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(jButton14, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (length > 0) {
            ...
            StringBuilder deleteCharAt = back.deleteCharAt(number);
            store = back.toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kalkolatorjava.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new kalkolatorjava().setVisible(true);
            }
        });
    }
    ...
    private static class back {
        ...
        private static void deleteCharAt(int number) {
    ...
    private static class StringBulider {
